...
// }
// const data=[1,2,3,4];
// console.log("originals data",data);
// console.log("muttet data",doublemap1(data));
// console.log("mutteted data",data);
...
//     const data=numbers.map((items,i)=>{
//         return items*2;
//     })
//     return data;
...
// const x2=()=>x.val*=1;     // output is 6    3*2
...
// composition of function
 ...
 const composition=(fn1,fn2)=>(value)=>fn2(fn1(value)*2);
